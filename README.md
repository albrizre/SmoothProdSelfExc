...
1 - Simulating patterns from a self-exciting spatio-temporal model with a smooth space-time varying productivity parameter (see Algorithm 1 in the paper) according to the three scenarios considered in the paper (the user can easily modify the spatio-temporal window or the offspring parameter function).
